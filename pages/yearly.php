        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Monthly
                                                        ...
                                                        <option menuItemName="Yearly" value="/billing/index.php?rp=/store/yearly" class="list-group-item" selected="selected">
                        Yearly
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product4">
                            <header>
                                <span id="product4-name">1 YEAR</span>
                                                            </header>
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/yearly/1-year" class="btn btn-success btn-sm btn-order-now" id="product4-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product7">
                            <header>
                                <span id="product7-name">2 YEAR</span>
                                                            </header>
                            <div class="product-desc">
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/yearly/2-year" class="btn btn-success btn-sm btn-order-now" id="product7-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product8">
                            <header>
                                <span id="product8-name">3 YEAR</span>
                                                            </header>
                            <div class="product-desc">
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/yearly/3-year" class="btn btn-success btn-sm btn-order-now" id="product8-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
...
<div class="modal fade" id="recommendationsModal" tabindex="-1" role="dialog">
    ...
    <form method="get" action="/billing/index.php?rp=%2Fstore%2Fyearly&">
