                ...
                <i class="fas fa-chevron-up card-minimise panel-minimise pull-right float-right"></i>
                    ...
                    <div class="list-group collapsable-card-body">
                            ...
                            Trial
                                                                                ...
                                                                                <a menuItemName="Monthly" href="monthly.php" class="list-group-item list-group-item-action active" id="Secondary_Sidebar-Categories-Monthly">
        ...
        <form role="form">
            <select class="form-control custom-select" onchange="selectChangeNavigate(this)">
                        ...
                        Trial
                                                        ...
                                                        <option menuItemName="Monthly" value="/billing/index.php?rp=/store/monthly" class="list-group-item" selected="selected">
                        Monthly
            ...
            <div class="products" id="products">
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product6">
                            <header>
                                <span id="product6-name">1 MONTH</span>
                                                            </header>
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/monthly/1-month" class="btn btn-success btn-sm btn-order-now" id="product6-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                        ...
                        <div class="product clearfix" id="product2">
                            <header>
                                <span id="product2-name">3 MONTHS</span>
                                                            </header>
                            <div class="product-desc">
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/monthly/3-months" class="btn btn-success btn-sm btn-order-now" id="product2-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
                ...
                <div class="row row-eq-height">
                        ...
                        <div class="product clearfix" id="product3">
                            <header>
                                <span id="product3-name">6 MONTHS</span>
                                                            </header>
                            <div class="product-desc">
...
99.99% Uptime<br />
                            ...
                            <footer>
                                ...
                                <a href="/billing/index.php?rp=/store/monthly/6-months" class="btn btn-success btn-sm btn-order-now" id="product3-order-button">
                                    <i class="fas fa-shopping-cart"></i>
                                    Order Now
                                </a>
                            </footer>
...
<div class="modal fade" id="recommendationsModal" tabindex="-1" role="dialog">
    ...
    <form method="get" action="/billing/index.php?rp=%2Fstore%2Fmonthly&">
